      ...
      <div className="w-full flex flex-wrap justify-center items-center gap-7">
        {productos.map(item => (
          <div
            ...
            className="w-72 h-[370px] flex flex-col justify-between items-center overflow-hidden border-2 border-orange-500 rounded-lg shadow-xl shadow-stone-400/50 hover:-translate-y-1 duration-200"
          >
            <div className="w-full h-[55%]">
              <img
                src={images[item.id_producto - 1]}
                alt=""
